...
parser.add_argument('--audio_input_prediction', default=['noisy_voice_long_t1.mp3'], type=list)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='denoise_t1.mp3', type=str)
